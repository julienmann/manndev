import"./style-B6LgcsJm.js";import{n as e,t}from"./session-wjVPXH76.js";var n=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 12h14M12 5l7 7-7 7"/></svg>`,r=`<div class="cta-underline-wrap"><div class="cta-underline"></div></div>`,i=document.querySelector(`#main`),a=document.querySelector(`#account-name`),o=document.querySelector(`#logout-btn`);function s(e){return e?new Date(e).toLocaleDateString(`en-US`,{month:`short`,day:`numeric`,year:`numeric`}):`—`}function c(){i.innerHTML=`
  ...
  `,document.querySelector(`#retry-btn`).addEventListener(`click`,d)}async function l(e){try{return(await fetch(`/client-files/${e}/preview/`,{method:`HEAD`,cache:`no-store`})).ok}catch{return!1}}function u(e,t,a){let o=`/client-files/${e}/preview/`,c=a?`
      <a class="link-cta" href="${o}" target="_blank" rel="noopener noreferrer">
        View live preview
        ${n}
        ${r}
      </a>
    `:`<span class="delivery-note">No live preview available yet.</span>`;i.innerHTML=`
